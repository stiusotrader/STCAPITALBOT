...
snapshot, indices, crypto, commodities, *, _ = build_market_snapshot()
...
snapshot, indices, _, _, *, stocks = build_market_snapshot()
...
def build_midday():
snapshot, *, crypto, commodities, forex, _ = build_market_snapshot()
...
def build_close():
snapshot, indices, crypto, commodities, *, stocks = build_market_snapshot()
analysis = ask_claude(
